...
def populate():
    ...
    django_pages = [
        ...
        'url':'https://docs.djangoproject.com/en/2.1/intro/tutorial01/', 'views':100},
        {'title':'Django Rocks',
        'url':'http://www.djangorocks.com/', 'views':100},
        {'title':'How to Tango with Django',
        'url':'http://www.tangowithdjango.com/', 'views':500}]
    
    other_pages = [
        {'title':'Bottle',
        'url':'http://bottlepy.org/docs/dev/', 'views':100},
        {'title':'Flask',
        'url':'http://flask.pocoo.org', 'views':400}]

    cats = {'Python': {'pages': python_pages, 'views': 128, 'likes': 64},
    'Django': {'pages': django_pages, 'views': 64, 'likes': 32},
    'Other Frameworks': {'pages': other_pages, 'views': 32, 'likes': 16} }

    #more categories or pages add above 
    #below adds categories and pages for that category
